...
class OyunActivity : ComponentActivity() {
    ...
    private val kelimeeListesii = listOf("hayat", "sevgi", "mutlu", "kalem", "resim", "aslan", "beyin","araba","kahve","maske","kitap","evren","namaz","sabit","makas")
    ...
    companion object {
        private const val maxDenemeeHakkiii = 5
    ...
    private fun kutulariiOlusturr(layouttDuzenii: LinearLayout) {
        ...
        kutularinnDuzenii.rowCount = 5 // Sabit satır sayısı 5
        kutularinnDuzenii.columnCount = 5 // Sabit sütun sayısı 5
        ...
        for (i in 0 until 5) { // Sabit satır sayısı 5
            for (j in 0 until 5) { // Sabit sütun sayısı 5
